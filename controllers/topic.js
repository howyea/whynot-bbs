...
exports.index = function(req, res, next) {
  ...
  var ep = EventProxy.create(events, function(
    topic,
    other_topics,
    no_reply_topics,
    is_collect
  ...
  Topic.getFullTopic(
    ...
    ep.done(function(message, topic, author, replies) {
      ...
      cache.get(
        "no_reply_topics",
        ep.done(function(no_reply_topics) {
          if (no_reply_topics) {
...
exports.put = function(req, res, next) {
  ...
  Topic.newAndSave(title, content, tab, req.session.user._id, function(
    err,
    topic
  ) {
    if (err) {
...
exports.showEdit = function(req, res, next) {
  ...
  Topic.getTopicById(topic_id, function(err, topic, tags) {
    ...
    if (
      String(topic.author_id) === String(req.session.user._id) ||
...
exports.collect = function(req, res, next) {
  ...
  Topic.getTopic(topic_id, function(err, topic) {
    ...
    TopicCollect.getTopicCollect(req.session.user._id, topic._id, function(
      err,
      doc
    ) {
      if (err) {
...
exports.de_collect = function(req, res, next) {
  ...
  Topic.getTopic(topic_id, function(err, topic) {
    ...
    TopicCollect.remove(req.session.user._id, topic._id, function(
      err,
      removeResult
    ) {
      if (err) {
